    ...
    return (
        <div className="hero min-h-screen "  style={{backgroundImage: 'url(https://i.postimg.cc/0yXMYgSD/bg-hero.jpg)'}}>
           <div className="hero-overlay bg-opacity-90"></div>
            <div className="md:flex lg:flex py-6 text-white ">
                {/* -----content */}
                <div className=" text-white mx-auto w-1/2  lg:text-start sm:p-0 lg:p-12 space-y-7 animate__animated animate__fadeInLeft  my-auto mt-8">
