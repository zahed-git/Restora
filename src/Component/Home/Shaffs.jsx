  ...
  <section className="mb-32 text-center">
    ...
    <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
      <div className="mb-24 md:mb-0">
        <div
          className="duration-500 hover:scale-105 hover:shadow-xl block h-full rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
